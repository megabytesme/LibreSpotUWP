...
namespace LibreSpotUWP.Views.Win11
{
    public sealed partial class AlbumPage : Page
    {
        ...
        private void NavigateToMain(string type, string id)
        {
            ...
            if (type == "Artist") shell?.NavigateToArtist(id);
            else shell?.NavigateToAlbum(id);
        }
        ...
        public async void OnTrackClicked(object sender, TrackClickedEventArgs e)
        {
            ...
            var queue = ViewModel.Tracks?.Items?
                ...
                .ToList();
            await App.Media.PlayAsync($"spotify:album:{ViewModel.Album.Id}", trackUri, queue, e.Index);
        }
