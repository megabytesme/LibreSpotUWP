...
namespace LibreSpotUWP.Views.Win11
{
    public sealed partial class SettingsPage_Win11 : Page
    {
        ...
        protected async void AppearanceRadio_Checked(object sender, RoutedEventArgs e)
        {
            ...
            {
            var selectedMode = SettingsPage_Win11.TagToMode(tag);
            ...
            var scrollContent = new ScrollViewer
            {
                Content = new TextBlock
                {
                    Inlines =
                    {
                        ...
                        new Hyperlink
                        {
                            NavigateUri = new Uri("https://github.com/megabytesme/librespot/tree/d329ad70a24fedb8938e4407893c435f6b3ea2f8"),
                            Inlines = { new Run { Text = "d329ad70a24fedb8938e4407893c435f6b3ea2f8" } }
                        },
                        new LineBreak(),
                        new LineBreak(),
        ...
        private void RunOnUI(Action action)
            => _ = Dispatcher.RunAsync(
                ...
                () =>
                {
                    ...
                    {
                        LogService.Error(ex, "[SettingsPage_Win11.RunOnUI] Failed.");
                        throw;
                    }
                });
        ...
        private void UpdateSpotifyApiStatus(AuthState state)
        {
            ...
            {
                LogService.Error(ex, "[SettingsPage_Win11.UpdateSpotifyApiStatus] Failed.");
                throw;
            }
        }
